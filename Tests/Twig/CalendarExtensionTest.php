<?php
namespace Slad\BookingBundle\Tests\Twig;

use Slad\BookingBundle\Twig\CalendarExtension;
...
class CalendarExtensionTest extends WebTestCase
{
    ...
    {
        new CalendarExtension('Slad\BookingBundle\Tests\Fixtures\ORM\Entity\Booking',
    ...
    public function testKernelShouldContainBCalendarExtension()
    {
        ...
        $this->assertInstanceOf('Slad\BookingBundle\Twig\CalendarExtension',
    ...
    {
        $this->assertEquals('slad_booking_bundle_calendar', $this->container->get('booking_calendar')->getName());
    }
